# Guía de DataAnalyzer
El analizador de datos usa la metodología de validación adoptada previamente y se encarga de usar dicha metodología para validar el resultado de la simulación del modelo de difusión de noticias SBFC. Esta metodología consiste en ejecutar la simulación 10 veces, calcular la media de agentes en cada estado posible y hallar la raíz del error cuadrático medio normalizado (NRMSE). Si NRMSE < 0.2 entonces el ajuste del modelo se considera válido.  
