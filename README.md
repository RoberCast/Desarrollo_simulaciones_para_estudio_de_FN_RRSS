...
The parameters.xml file contains the default model parameters. You can now run Repast Simphony in GUI mode (an single simulation) or in batch mode. To fit the model with real data, run the model in batch mode, choosing the "DataAnalyzer JAR/Resources 
